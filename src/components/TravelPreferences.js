      ...
      <form>
        <div className="form-group">
          ...
          <input
            ...
            required
          />
          {errors.departureDate && <div className="error-message text-danger">{errors.departureDate}</div>}
        </div>
        <div className="form-group">
          ...
          <input
            ...
            required
          />
          {errors.returnDate && <div className="error-message text-danger">{errors.returnDate}</div>}
        </div>
        <div className="form-group">
          ...
          {errors.accommodation && <div className="error-message text-danger">{errors.accommodation}</div>}
        </div>
        <div className="form-group">
          ...
          <textarea
            ...
            onChange={handleChange}
            placeholder="Add any special requests or preferences here (optional)"
          />
        </div>
